...
df = pd.read_excel("C:\\Users\\gan8k\\OneDrive - Contoso\\Desktop\\Revised Project\\Dataset\\CustomerID.xlsx")
df_new = df[df['EmailID'] == EmailID]

if st.button('VIEW YOUR HISTORY'):
    if EmailID == ('PLEASE CONFIRM YOUR EMAIL ID'):
        st.warning('PLEASE SELECT THE YOUR EMAILID TO PROCEED', icon="⚠️")
